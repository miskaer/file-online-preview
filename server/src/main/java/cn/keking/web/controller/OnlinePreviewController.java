...
public class OnlinePreviewController {
    ...
    public String onlinePreview(String url,String src, Model model, HttpServletRequest req) throws SQLException {
        String fileUrl;
        try {
        ...
        logger.info("预览文件url：{}", src);
        //这里不在进行URL 处理了
        FileAttribute fileAttribute = fileHandlerService.getFileAttribute(fileUrl, req);
        Db.use(ds).insertOrUpdate(Entity.create("doc")
                .set("src",src)
                .set("other",fileAttribute.getOutFilePath()), "src");
